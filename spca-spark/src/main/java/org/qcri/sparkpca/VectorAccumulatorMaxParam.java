 ...
 * two double[] and it returns the a double[] that contains the maximum from each two corresponding elements 
 * 
 * @author Tarek Elgamal
 *
 */
public class VectorAccumulatorMaxParam implements AccumulatorParam<double[]> {
	...
	public double[] zero(double[] arg0) {
		for(int i=0; i< arg0.length; i++)
		{
			arg0[i]=Double.NEGATIVE_INFINITY;
		}
		return arg0;
	}
