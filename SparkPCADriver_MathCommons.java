    ...
    */
    ...
    for (; round <= LAST_ROUND
      ...
      */
      ...
      final Accumulator<Matrix> matrixAccumXtx_mahout = sc.accumulator(new DenseMatrix(nPCs,nPCs), new MahoutMatrixAccumulatorParam());
      final Accumulator<Matrix> matrixAccumYtx_mahout = sc.accumulator(new DenseMatrix(nCols,nPCs), new MahoutMatrixAccumulatorParam());
      final Accumulator<Vector> matrixAccumX_mahout = sc.accumulator(new DenseVector(nPCs), new MahoutVectorAccumulatorParam());
      ...
      //final DenseMatrix resMatrix =new DenseMatrix(nCols, nPCs); 
            ...
            rows.foreach(  new VoidFunction<ExtendedRealVector>() {
                public void call(ExtendedRealVector yi) throws Exception {
                       ...
                       //////////////////Mahout
                       SerializableDenseVector yi_mahout= new SerializableDenseVector(yi.toArray());
                	   ...
                	   Matrix centralXtxi = PCACommon.outerProduct(xi_mahout, br_xm_mahout.value(), xi_mahout, br_xm_mahout.value(), resMatrix);
                	 			...
                	 			//matrixAccumX_mahout.add(xi_mahout);
                	 			/*
                        matrixAccumXtx_mahout.add(centralXtxi);
                	 			matrixAccumYtx_mahout.add(centralYtxi);
                	 			*/
